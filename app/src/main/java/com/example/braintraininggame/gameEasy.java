...
//                }else{
                ...
                //used to code skip question and check answer
                clickCount++;
                if (clickCount == 1) {
                    check();
                } else {
                    if (questionCount < 10) {
                        ...
                        Intent easyScore = new Intent(gameEasy.this, Score.class);
                        easyScore.putExtra("easyScore", score);
                        startActivity(easyScore);
                    }
    ...
    private void check() {
        ...
        check = Integer.valueOf(String.valueOf(ansTxt.getText()));
