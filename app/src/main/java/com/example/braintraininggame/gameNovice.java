...
public class gameNovice extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        showHint = (TextView)findViewById(R.id.hint);
        easyQuestion();
        ...
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                if(String.valueOf(typeAns.getText()).length() < 1){
...
//                }else{
                ...
                if (clickCount == 1) {
                    ...
                    if (questionCount < 10) {
                        ...
                        Intent noviceScore = new Intent(gameNovice.this, Score.class);
                        noviceScore.putExtra("noviceScore", score);
                        startActivity(noviceScore);
                    }
    ...
    private void check() {
        ...
        if (on) {  //checking toggle button status
            if (hintCount < 4) {
                if (check > answer) {
                    showHint.setText("Less");
                } else if (check < answer) {
                    showHint.setText("Greater");
                } else {
                    showHint.setText("Correct");
                }
            } else {
                easyQuestion();
            }
